...
- [ADR 0011 — Provider-neutral issue intake uses adapter-backed work items](0011-provider-neutral-issue-intake.md): issue intake reads provider-hosted work items through adapters while local contracts remain the source of truth.
