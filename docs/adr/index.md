...
- [ADR 0011 — Provider-neutral issue intake uses adapter-backed tracked items](0011-provider-neutral-issue-intake.md): issue intake reads provider-hosted tracked items through adapters while local contracts remain the source of truth.
